...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="{{ asset('admin/img/team-3.jpg') }}"
                    alt="{{ asset('admin/img/team-3.jpg') }}" /></div>
            <div class="col-lg-5">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            <a class="btn btn-primary btn-sm" href="{{ url('user/detail/' . $prod->id) }}">View
                                Details</a>
                        </div>
                    </div>
                </div>
